			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							...
							<ol class="breadcrumb">
								...
								<li class="active">
									<span>Դիտել բժշկական պատմությունը</span>
								</li>
							</ol>
						</div>
					</section>
					<div class="container-fluid container-fullw bg-white">
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Դիտել  <span class="text-bold">բժշկական պատմությունը</span></h5>

								<table class="table table-hover" id="sample-table-1">
									<thead>
										<tr>
											<th class="center">#</th>
											<th>Պացիենտի անուն</th>
											<th>Պացիենտի հեռ․ համար</th>
											<th>Պացիենտի սեռ </th>
