			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Օգտատեր | Խմբագրել էջը</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Օգտատեր </span>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Խմբագրել էջը</h5>
											</div>
											<div class="panel-body">
												...
												?>
													<h4><?php echo htmlentities($data['fullName']); ?>ի անձնական էջ</h4>
													<p><b>Էջի ստեղծման ամսաթիվը: </b><?php echo htmlentities($data['regDate']); ?></p>
													...
													<form role="form" name="edit" method="post">
														...
														<div class="form-group">
															...
															<a href="change-emaild.php">Թարմացնել էլ․ հասցեն</a>
														</div>
