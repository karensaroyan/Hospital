			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | Ընթերցված հարցումները</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
								...
								<li class="active">
									<span>Ընթերցված հարցումները</span>
								</li>
							</ol>
						</div>
					</section>
					...
					<div class="container-fluid container-fullw bg-white">
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Ընթերցված <span class="text-bold"> հարցումները</span></h5>
