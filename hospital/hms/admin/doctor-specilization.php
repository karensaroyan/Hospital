...
<head>
	<title>Admin | ԲԺԻՇԿՆԵՐԻ ՄԱՍՆԱԳԻՏՈՒԹՅՈՒՆՆԵՐ</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | ԱՎԵԼԱՑՆԵԼ ԲԺԻՇԿՆԵՐԻ ՄԱՍՆԱԳԻՏՈՒԹՅՈՒՆՆԵՐ</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
								...
								<li class="active">
									<span>Լրացնել բժշկական մասնագիտացում</span>
								</li>
							</ol>
						</div>
					</section>
					...
					<div class="container-fluid container-fullw bg-white">
									...
									<div class="col-lg-6 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Բժշկի մասնագիտություն</h5>
											</div>
											<div class="panel-body">
												...
												<form role="form" name="dcotorspcl" method="post">
													<div class="form-group">
														...
														<input type="text" name="doctorspecilization" class="form-control" placeholder="Ավելացրեք բժշկի մասնագիտություն">
													</div>




													<button type="submit" name="submit" class="btn btn-o btn-success btn1">
														Հաստատել
													</button>
												</form>
											</div>
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Բոլոր <span class="text-bold">մասնագիտությունները</span></h5>
								...
								<table class="table table-hover" id="sample-table-1">
									<thead>
										<tr>
											...
											<th class="hidden-xs">Ստեղծման ամսաթիվը</th>
											<th>Թարմացման ամսաթիվը</th>
